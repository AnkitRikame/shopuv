const cart = [{
        ...
        price: "4,450/-",
        carous_images: ["./images/idp2.jpg", "./images/idp3.jpg", "./images/idp4.jpg", "./images/idp1.jpg", "./images/idp5.jpg"],
        description : `1.Experience younger and brighter skin with the miraculous ampoule with a high concentrate of
        ...
        tabs : {
            pd :`
            <p id="nav-home-p">
                The Ultra V Idebenone Ampoule is an intensive treatment for brighter and younger-looking
                skin. It will hydrate and brighten the skin while improving visible signs of ageing like
                wrinkles and fine lines. You can expect your
                skin to look and feel more moisturized and have a shine all day long with the help of
    ...
    // 2.Aqua shine sheet mask
    {
        ...
        price: "1,950/-",
        carous_images: ["./images/uv1.jpg", "./images/uv2.jpg", "./images/uv3.jpg", "./images/uv4.jpg", "./images/uv5.jpg"],
        description : `This facial mask containing Idebenone, 3GF Complex and Niacinamide as key ingredients will help make your skin look brighter and healthier. Also, the increase in moisture and nutrition will keep it glowing all day long.`,
        option : ["25ml x 10ea","25 ml x 1ea"],
        tabs : {
            pd :`
            <p id="nav-home-p">
            It is unique as it combines the simplicity of a sheet mask with some of the latest cutting-edge ingredients which is why we like to call it a ‘Treatment Mask’. The results after using this product will be above and beyond your
            average sheet mask because of the ingredients used in its formulation. You can expect your skin to look and feel brighter, more moisturised and healthier almost instantly.
            </p>
    ...
    // 3.Idebenone Cream
    {
        ...
        description : `A dual functional cream with both whitening and anti-wrinkle benefits. It will moisturise the skin without irritating it, leaving the skin looking and feeling firmer, younger and brighter.`,
        option : ["20ml"],
        tabs : {
            pd :`
            <p id="nav-home-p">
            Idebenone, one of the most cutting-edge anti-aging antioxidants on the market today, shields skin from environmental damage, improves the appearance of fine lines, reduces dryness, and smooths the texture of the skin. Based
            on tests comparing it to other antioxidants like vitamins C and E, Idebenone is being called "the most potent and effective antioxidant" known and tested in skincare today. Idebenone is especially potent at preventing sun
            damage.
            <br> 
            Must Know:
            </p>
    ...
    // 5.Pep
    {
        ...
        price: "4,590/-",
        carous_images: ["./images/idp2.jpg", "./images/idp3.jpg", "./images/idp4.jpg", "./images/idp1.jpg", "./images/idp5.jpg"],
        description : `5.Experience younger and brighter skin with the miraculous ampoule with a high concentrate of
        the highest ranked anti-oxidant – patented Idebenone, hyaluronic acid, niacinamide, EGF and
        so much more.`,
        option : ["6ml x 4 vials"],
        tabs : {
